...
------------------------
Poor man's reflection to help with loading/saving/transfer of objects

[role="incremental"]
To semi-automate work, every class can declare which members gets serialized

[role="incremental"]
This is achieved via the well tested combination of lots of templated helper functions and macro glue!
