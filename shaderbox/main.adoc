...
[state=STL]
== "Standard Library"
//TODO: table styling attributes are ignored
...
void static_recurse(Arg0&& a0, Args&&... args)
{
    ...
    static_recurse<I + detail::get_size<Arg0>()>(
        std::forward<Args>(args)...
    );
}
-----
...
{
    return max(-d2, d1); // defined only for vectors!
}
- {blank}
+
...
| 240x240 px | 85.62 FPS | 166.77
| 120x120 px | 100.27 FPS | 468.49
|==========================================================================================
