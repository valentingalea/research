...
movss   xmm1, DWORD PTR $T2[rsp]
cvtps2pd xmm2, xmm1
movss   DWORD PTR v$[rsp+4], xmm1
movsd   xmm1, QWORD PTR __real@3ff000000
movq    r8, xmm2
movss   DWORD PTR v$[rsp], xmm0
movq    rdx, xmm1
movss   xmm0, DWORD PTR $T2[rsp+4]
movss   DWORD PTR v$[rsp+8], xmm0
call    printf
-----
|==================
...
mov     edi, OFFSET FLAT:.LC0
mov     eax, 2
vcvtss2sd  xmm1, xmm1, DWORD PTR [rsp+8]
call    printf
-----
...
lea     rcx, OFFSET FLAT:`string'
mov     QWORD PTR $T2[rsp], rax
vmovss  xmm1, DWORD PTR $T2[rsp]
vcvtss2sd xmm2, xmm1, xmm1
vmovss  DWORD PTR v$[rsp+4], xmm1
vmovsd  xmm1, QWORD PTR __real@3ff000000
vmovss  DWORD PTR v$[rsp], xmm0
vmovss  xmm0, DWORD PTR $T2[rsp+4]
vmovq   rdx, xmm1
vmovq   r8, xmm2
vmovss  DWORD PTR v$[rsp+8], xmm0
call    printf
-----
|==================
...
== !
TODO: introduce here the folding
